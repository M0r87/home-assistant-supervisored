...
URL_RAW_BASE="https://raw.githubusercontent.com/M0r87/home-assistant-supervisored/main/files"
...
info "$PREFIX"
info "Manually RUN: curl -sL $URL_BIN_HASSIO > $PREFIX/sbin/hassio-supervisor"
info "Manually RUN: curl -sL $URL_SERVICE_HASSIO > $SYSCONFDIR/systemd/system/hassio-supervisor.service"
